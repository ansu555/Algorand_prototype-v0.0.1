            ...
            {open && (
              <div className="border-b border-slate-200/60 px-3 py-2 text-xs text-slate-600 dark:border-white/10 dark:text-slate-300">
                <div className="mb-1 flex items-center justify-between">
                  <span className="font-semibold text-slate-900 dark:text-slate-200">AI Chatbot Guidelines</span>
                  <button
                ...
                {showRules && (
                  <div className="relative rounded-lg border border-red-300/30 bg-red-50/80 p-2 dark:border-[#F3C623]/30 dark:bg-[#F3C623]/10">
                    ...
                    <div className="grid max-h-48 gap-2 overflow-y-auto pr-2 pl-2">
                      ...
                      <div>
                        <div className="mb-1 font-medium text-slate-900 dark:text-slate-200">💸 Sending Transactions</div>
                        <ul className="list-disc space-y-1 pl-5">
                          <li>You can send ALGO or any ASA token to <strong>any valid Algorand address</strong></li>
                          <li>Example: "send 1 ALGO to WXYZ..." (paste full 58-character address)</li>
                          <li>Example: "transfer 5 USDC to ABC123..."</li>
                          <li>I'll confirm transaction details before executing</li>
                          <li>Make sure you have sufficient balance for the transfer</li>
                        </ul>
                      </div>
                      <div>
                        <div className="mb-1 font-medium text-slate-900 dark:text-slate-200">⚠️ Important Notes</div>
                        <ul className="list-disc space-y-1 pl-5">
                          <li>Connect your wallet for transaction features</li>
                          <li>Algorand addresses are exactly 58 characters</li>
                          <li>Double-check recipient addresses before sending</li>
                          <li>Transaction fees apply (~0.001 ALGO per txn)</li>
